...
export const bocados = [
    { id: 'tab1', img: blondie, alt: '', title: 'titulo 1', description: 'adjsalk asdlisad hasildhl hsads sjald asdnl nsa,dnkas ,sahd, ,asbdk bsad' },
...
export const tortas = [
    { id: 'tab1', img: panJamon, title: 'titulo tortas1 ', alt: '', description: 'adjsalk asdlisad hasildhl hsads sjald asdnl nsa,dnkas ,sahd, ,asbdk bsad' },
